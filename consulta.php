...
<html lang="pt-br">
    <head>
        ...
        <link id="css" rel="stylesheet" type="text/css" href="style/consulta.css">
            ...
            <form name="form" method="post" action="<?=$_SERVER['PHP_SELF']?>" id="consulta-form">
                ...
                <div class="linha-filtros">
                    <div class="esquerda-quatro">
                        <label>Nome</label> 
                        <input type="text" name="nome" placeholder="Digite o nome" class="form-control" maxlength="50" id="nome-txt"/>
                    </div>
                    ...
                    <div class="esquerda-quatro-menor">
                        ...
                        <select name="mes" class="form-control pointer">
                ...
                <div class="linha-filtros">
                    ...
                    <div class="esquerda-tres sem-padding-right">
                        <label >Usuário</label>
                        <input type="text" name="usuario" placeholder="Digite o usuário" class="form-control" maxlength="20"/>
                    </div>
                    <div class="linha-filtros">
